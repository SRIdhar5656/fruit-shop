...
function Footer() {
  return (
    ...
    <footer class="bg-white dark:bg-lime-800 pt-4 pb-8 xl:pt-8 my-10">
    <div class="max-w-screen-lg px-4 mx-auto text-gray-400 xl:max-w-screen-xl sm:px-6 md:px-8 dark:text-gray-400">
        ...
        <div class="text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
            ...
            <div class="text-center pt-10 sm:pt-12 font-light flex items-center justify-center dark:hover:text-white">
                Created by  SRIDHAR
            </div>
        </div>
    </footer>
